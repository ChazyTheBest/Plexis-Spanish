...
return array(
    ...
    'account_recover_pass_failed' => 'A critical error happened while updating your password. Please contact an administrator to resolve this issue.',
    ...
    'account_unable_to_activate' => 'Invalid activation key or email. If you feel you received this message in error, please contact an administrator.',
    ...
    'login_failed_account_unactivated' => "<strong>Login Failed:</strong> Your account has not been activated. Please click the link in your activation email to enable access to your account.",
    ...
    'module_uninstall_error' => "There was an error while uninstalling this module. Please check your error / debug logs.",
    ...
    'news_delete_error' => "<strong>Error!</strong> There was an error deleting the news post. Please check your error logs.",
    'news_post_error' => "<strong>Error!</strong> There was an error submitting the news post. Please check your error logs.",
    ...
    'realm_default_failed' => 'There was an error updating the config file! Please check your error logs.',
    ...
    'realm_uninstall_error' => 'There was an error uninstalling the realm in the database. Please check your error logs.',
    'realm_uninstall_success' => 'Realm successfully uninstalled!',
    ...
    'reg_failed_ip_banned' => "Your IP address is Banned. You are unauthorized to create anymore accounts.",
    ...
    'template_default_failed' => 'There was an error updating the config file! Please check your error logs.',
    ...
    'template_uninstall_error' => 'There was an error uninstalling this template. Please check your error logs.',
    'template_uninstall_success' => 'Template successfully uninstalled!',
